...
// Đặt tên file hợp lệ cho checkpoint đầu tiên
WebUI.takeScreenshotAsCheckpoint('Make_Appointment_Page_Validation.png')
...
WebUI.takeScreenshotAsCheckpoint('Login_Page_Validation.png')

WebUI.click(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/button_Login'))

WebUI.takeFullPageScreenshotAsCheckpoint('Appointment_Page_Validation.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('Appointment_Confirmation_Validation.png')
